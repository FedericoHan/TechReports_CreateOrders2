...
class CreateOrders(object):
    ...
    def create_orders_df(self, days_to_expiry = 2):
        ...
        expiry = dt.datetime.today() + pd.tseries.offsets.BusinessDay(n = days_to_expiry) #expire 1Bd after today
...
if __name__ == "__main__":
    ...
    eur = CreateOrders(merged_g10, distance_from_techs = 0.2,  order_Type ='TP', Client = 'CP85VC', Account = 'FXOETFSG2', Ccy1 = 'EUR', Ccy2 = 'USD', \
                      ...
                      amount_basic = 1e6, odas_below = 2, odas_above = 3, gamma_local = 1, gamma_below =  1, gamma_above = -1)  
    eur_format = eur.create_orders_df(days_to_expiry = 2)   
    ...
    jpy_format = jpy.create_orders_df(days_to_expiry = 3)
    ...
    cnh_format = cnh.create_orders_df(days_to_expiry = 2)
    ...
    php_format = php.create_orders_df(days_to_expiry = 2)
